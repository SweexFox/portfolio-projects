...
**Цель проекта**\
Благотворительный фонд хочет лучше узнать своих благотворителей. Вся работа посвящена этому.
Таким образом фонд сможет эффективно выстроить взаимодействие с донорами.

<span style="font-weight: 600"> Для достижения поставленной цели были поставлены следующие задачи.</span>1. Исследовательский анализ данных.
